...
public class AnnouncementAdapter extends ArrayAdapter<AnnouncementModel>
{
        ...
        AnnouncementAdapter(Context context, ArrayList<AnnouncementModel> users)
        {
        ...
        public View getView(int position, View convertView, @NonNull ViewGroup parent)
        {
            ...
            if (convertView == null)
            {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.announcements_list, parent, false);
            }
